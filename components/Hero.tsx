...
const Hero: React.FC<HeroProps> = ({ onLoginSuccess, onBrowse }) => {
    ...
    <div className="relative min-h-screen flex items-center justify-center pt-20 pb-12 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0 bg-black">
        <video 
          ...
          muted 
          playsInline
          poster="https://i.imgur.com/J1MWCQC.jpeg"
          onError={() => {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-4">
              <button 
                onClick={onBrowse}
                className="text-white/80 hover:text-white border-b border-white/30 hover:border-white transition-all pb-1 text-sm font-medium"
              >
